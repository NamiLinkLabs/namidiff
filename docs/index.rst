...
**Namidiff** is a high-performance tool and library designed for diffing large datasets across databases. By executing the diff calculation within the database itself, Namidiff minimizes data transfer and achieves optimal performance.
...
- Developer Documentation
   ...
   - `How Namidiff works - a deep-dive technical blog post  <https://eshsoft.com/blog/how-reladiff-works>`_

- Other links
   - Github: `<https://github.com/NamiLinkLabs/namidiff>`_
   - Upstream reladiff: `<https://github.com/erezsh/reladiff>`_
