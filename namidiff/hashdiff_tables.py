...
from namidiff.sqeleton.abcs import ColType_UUID, NumericType, PrecisionType, StringType, Boolean
...
class HashDiffer(TableDiffer):
    ...
    def _validate_and_adjust_columns(self, table1, table2):
        ...
        for c1, c2 in safezip(table1.relevant_columns, table2.relevant_columns):
            ...
            if isinstance(col1, PrecisionType):
                ...
                # Floats are always rounded (never truncated): float32/float64 noise can go in opposite
                # directions (17.9899999 vs 17.9900001), and truncation would split them into different values.
    ...
    def _diff_segments(
        ...
        # default, namidiff will checksum the section first (when it's below
