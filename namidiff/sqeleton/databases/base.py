...
from namidiff.sqeleton.queries.compiler import CompiledCode
    ...
    def dec(f):
        ...
        def _inner():
            try:
                ...
                s = text
                if package:
                    s += f"You can install it using 'pip install namidiff[{package}]'."
...
class Database(AbstractDatabase[T]):
    ...
    Instanciated using :meth:`~namidiff.sqeleton.connect`
    """
