...
from namidiff.sqeleton.abcs import DbTime, DbPath, AbstractDatabase
...
try:
    ...
    try:
        __version__ = _pkg_version("namidiff")
...
def connect_to_table(
    ...
    **kwargs,
    ...
    Parameters:
        db_info: Either a URI string, dict of connection options or a namidiff AbstractDatabase type.
