...
- Run namidiff with the `-d` switch for extra debug information.

If possible, please paste these as text, and not a screenshot.

**Describe the environment**

Describe which OS you're using, which namidiff version, and any other information that might be relevant to this bug.
